...
```
There were `r inline_text(table1, variable = "FeelingMasculine", level="Very masculine")` of `r nrow(masculinity_subset)` study respondents who reported feeling "Very Masculine"
...
barplot(prop.table(table(masculinity_subset$Age_cat)),
									 legend.text = NULL, angle = 45,
									 main = "Age Among Masculinity Survey Respondents",
				xlab = "Age Bracket",
...
Of `r totalstudy` participants in the study, `r sum(masculinity_subset$Age_cat=='18 - 34')` reported they were between 18 and 34 years of age.
